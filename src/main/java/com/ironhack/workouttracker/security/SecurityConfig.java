package com.ironhack.workouttracker.security;

import com.ironhack.workouttracker.security.filters.CustomAuthenticationFilter;
import com.ironhack.workouttracker.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET,"/api/workouts/").hasAnyAuthority("ROLE_USER")
                .requestMatchers(POST,"/api/exercises/").hasAnyAuthority("ROLE_ADMIN", "ROLE_USER")
                ...
                .requestMatchers("/api/personal-bests/**").permitAll()
